...
(
    ...
    author_id  UUID                     NOT NULL REFERENCES test.users (user_id),
...
(
    ...
    author_id  UUID                                               NOT NULL REFERENCES test.users (user_id) ON DELETE CASCADE,
    news_id    UUID                                               NOT NULL REFERENCES test.news (news_id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS news_title_id_idx ON test.news (title);